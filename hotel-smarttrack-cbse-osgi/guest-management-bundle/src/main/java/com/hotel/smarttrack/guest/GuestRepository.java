...
public class GuestRepository {
    ...
    public Guest save(Guest g) {
        if (g == null) throw new IllegalArgumentException("Guest is null");
    ...
    public Optional<Guest> findByEmail(String email) {
        ...
        for (Guest g : guests.values()) {
            if (g.getEmail() != null && email.equalsIgnoreCase(g.getEmail())) return Optional.of(g);
        }
    ...
    public Optional<Guest> findByPhone(String phone) {
        ...
        for (Guest g : guests.values()) {
            if (g.getPhone() != null && phone.equals(g.getPhone())) return Optional.of(g);
        }
        return Optional.empty();
    }
    ...
    public List<Guest> search(String term) {
        ...
        for (Guest g : guests.values()) {
            boolean match =
                    (g.getName() != null && g.getName().toLowerCase().contains(t)) ||
